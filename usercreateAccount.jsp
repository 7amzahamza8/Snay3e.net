...
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            if (locationIdStr == null || locationIdStr.isEmpty() || ageStr == null || ageStr.isEmpty()) {
                throw new Exception("Missing required fields: location or age.");
            }
            ...
            PreparedStatement insertUser = conn.prepareStatement(
                "INSERT INTO users (name, age, email, password, location_id, personal_image, contact_id) VALUES (?, ?, ?, ?, ?, NULL, ?)"
            );
            insertUser.setString(1, name);
            insertUser.setInt(2, age);
            insertUser.setString(3, email);
            insertUser.setString(4, password);
            insertUser.setInt(5, locationId);
            insertUser.setInt(6, contactId);
...
<div class="container">
    ...
    <h2><i class="fas fa-tools"></i>User Registration</h2>
