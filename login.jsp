...
Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            PreparedStatement stmt = conn.prepareStatement(
                "SELECT c.Name, p.Description FROM Craftsman c " +
                "JOIN Profile p ON p.id = c.Profile_id " +
                "JOIN Contact con ON p.Contact_ID = con.id " +
                "WHERE con.email = ? AND p.password = ?"
            );
...
<body>
    <div class="container">
        ...
        <div class="login-section">
            ...
            <div class="signup1">
                       Don't have an account as a craftsman? <a href="createAccount.jsp">Sign up</a>
            </div>
            <div class="signup">
                Want to join as a user? <a href="userLogin.jsp">click here</a>
            </div>
